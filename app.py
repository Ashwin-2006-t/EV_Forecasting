...
st.markdown("""
    <style>
        /* App background: dark green to black gradient */
        .stApp {
            background: linear-gradient(to right, #003300, #000000);
        ...
        /* Labels (e.g., for dropdowns and inputs) */
        label, .css-17eq0hr {
...
# Image
st.image("ev-car.png", use_container_width=True)
...
st.success("Forecast has been complete")

st.markdown("Done by Ashwin T")
